; NSIS description file for Quake Wars data file installer

SetCompressor lzma

!define NAME "Quake Wars"
!define FSNAME "quakewars-data"
!define VERSION "1.0"
!define RELEASE "1"
...
!define MULTIUSER_INSTALLMODE_DEFAULT_REGISTRY_KEY "Software\quakewars"
!define MULTIUSER_INSTALLMODE_DEFAULT_REGISTRY_VALUENAME "Install_Mode"
!define MULTIUSER_INSTALLMODE_INSTDIR_REGISTRY_KEY "Software\quakewars"
!define MULTIUSER_INSTALLMODE_INSTDIR_REGISTRY_VALUENAME "Install_Dir"
!define MULTIUSER_INSTALLMODE_INSTDIR "Quake Wars"
...
!include "MUI2.nsh"
!define MUI_ICON "../quakewars.ico"

; The name of the installer
Name "${NAME}-${VERSION} for Quake Wars"
...
Function .onInit
  ...
  ReadRegStr $0 SHCTX "Software\quakewars" ${MULTIUSER_INSTALLMODE_INSTDIR_REGISTRY_VALUENAME}
  IfErrors 0 oninitdone
    MessageBox MB_OK "You need to install Quake Wars first"
    Abort
  oninitdone:
FunctionEnd
...
Section /o "${NAME} CDROM" sec_q3acd
	...
	StrCmp $q3a_pak0 "notfound" 0 q3apak0copy
		call findq3acd
	q3apak0copy:
	CopyFiles $q3a_pak0 "$INSTDIR\Data"
...
Function findq3acd_cb
	StrCpy $R1 "$9Data\pak0.pk3"
	IfFileExists $R1 q3acd_cb_found 0
	StrCpy $R1 "$9quake3\Data\pak0.pk3"
...
Section "Quake III Team Arena" sec_q3ta
  ...
  CreateShortCut "$SMPROGRAMS\Quake Wars\Team Arena.lnk" "$INSTDIR\quakewars.x86.exe" "+set fs_game missionpack" "$INSTDIR\quakewars.x86.exe" 0 "" "" "Team Arena"
...
Section "un.Quake Wars" sec_un_q3a
  ...
  Delete $INSTDIR\Data\pak1.pk3
  Delete $INSTDIR\Data\pak2.pk3
  Delete $INSTDIR\Data\pak3.pk3
  Delete $INSTDIR\Data\pak4.pk3
  Delete $INSTDIR\Data\pak5.pk3
  Delete $INSTDIR\Data\pak6.pk3
  Delete $INSTDIR\Data\pak7.pk3
  Delete $INSTDIR\Data\pak8.pk3
  ...
  Delete "$SMPROGRAMS\Quake Wars\Quake Wars.lnk"
  Delete "$SMPROGRAMS\Quake Wars\Team Arena.lnk"

  ; Remove directories used
  RMDir "$SMPROGRAMS\Quake Wars"
  RMDir "$INSTDIR\Data"
