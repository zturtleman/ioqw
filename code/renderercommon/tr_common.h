...
// any change in the LIGHTMAP_* defines here MUST be reflected in R_FindShader() in tr_bsp.c
...
extern cvar_t *r_ext_multisample;			// 0 = use framebuffer depth, 16 = use 16-bit textures, 32 = use 32-bit textures, all else = error
