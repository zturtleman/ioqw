...
void AAS_SetWeaponJumpAreaFlags(void)
{
	...
	for (ent = AAS_NextBSPEntity(0); ent; ent = AAS_NextBSPEntity(ent))
	{
		if (!AAS_ValueForBSPEpairKey(ent, "classname", classname, MAX_EPAIRKEY)) continue;
		if (
			!strcmp(classname, "item_armor_full") ||
			...
			!strcmp(classname, "weapon_beamgun") ||
			!strcmp(classname, "weapon_chaingun") ||
			!strcmp(classname, "weapon_nailgun") ||
			!strcmp(classname, "weapon_plasmagun") ||
			!strcmp(classname, "weapon_railgun") ||
			!strcmp(classname, "weapon_bfg") ||
			!strcmp(classname, "item_quad") ||
			!strcmp(classname, "item_invis") ||
			!strcmp(classname, "item_regen") ||
			!strcmp(classname, "holdable_kamikaze") ||
			!strcmp(classname, "item_ammoregen") ||
			!strcmp(classname, "item_guard") ||
			!strcmp(classname, "item_doubler") ||
			!strcmp(classname, "item_scout"))
		{
			if (AAS_VectorForBSPEpairKey(ent, "origin", origin))
			{
				spawnflags = 0;
