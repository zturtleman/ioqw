...
#define MAX_SOUNDBYTES (256 * 1024 * 1024) // 256 MiB MAXIMUM...
...
void dmaHD_FreeOldestSound(void) {
	...
	if ((buffer = (short *)sfx->soundData) != NULL) {
		free(buffer);
	}
...
short *dmaHD_AllocateSoundBuffer(int samples) {
	...
	do {
		if ((buffer = (short *)malloc(bytes)) != NULL) {
			break;
		}
...
=======================================================================================================================================
	...
	This also means that at least twice more memory is used.
...
/*
=======================================================================================================================================
dmaHD_InterpolateHermite4pt3oX
=======================================================================================================================================
*/
...
/*
=======================================================================================================================================
dmaHD_GetSampleRaw_16bitStereo
=======================================================================================================================================
*/
...
=======================================================================================================================================
*/
static int dmaHD_GetInterpolatedSampleHermite4pt3oX(float t, int samples, byte *data, int (*dmaHD_GetSampleRaw)(int, int, byte *)) {
	int x, val;
	...
	x = (int)t;
	// interpolate
	val = (int)dmaHD_InterpolateHermite4pt3oX((float)dmaHD_GetSampleRaw(x - 1, samples, data), (float)dmaHD_GetSampleRaw(x, samples, data), (float)dmaHD_GetSampleRaw(x + 1, samples, data), (float)dmaHD_GetSampleRaw(x + 2, samples, data), FLOAT_DECIMAL_PART(t));
	// clamp
	return SMPCLAMP(val);
}
...
/*
=======================================================================================================================================
dmaHD_GetInterpolatedSampleCubic

't' must be a float between 0 and samples.
=======================================================================================================================================
*/
static int dmaHD_GetInterpolatedSampleCubic(float t, int samples, byte *data, int (*dmaHD_GetSampleRaw)(int, int, byte *)) {
	int x, val;
	...
	x = (int)t;
	// interpolate
	val = (int)dmaHD_InterpolateCubic((float)dmaHD_GetSampleRaw(x - 1, samples, data), (float)dmaHD_GetSampleRaw(x, samples, data), (float)dmaHD_GetSampleRaw(x + 1, samples, data), (float)dmaHD_GetSampleRaw(x + 2, samples, data), FLOAT_DECIMAL_PART(t));
	// clamp
	return SMPCLAMP(val);
}
...
/*
=======================================================================================================================================
dmaHD_GetInterpolatedSampleLinear

't' must be a float between 0 and samples.
=======================================================================================================================================
*/
static int dmaHD_GetInterpolatedSampleLinear(float t, int samples, byte *data, int (*dmaHD_GetSampleRaw)(int, int, byte *)) {
	int x, val;
	float c0, c1;
...
/*
=======================================================================================================================================
dmaHD_GetNoInterpolationSample

't' must be a float between 0 and samples.
=======================================================================================================================================
*/
static int dmaHD_GetNoInterpolationSample(float t, int samples, byte *data, int (*dmaHD_GetSampleRaw)(int, int, byte *)) {
	int x;
...
int (*dmaHD_GetInterpolatedSample)(float t, int samples, byte *data, int (*dmaHD_GetSampleRaw)(int, int, byte *)) = dmaHD_GetInterpolatedSampleHermite4pt3oX;
...
qboolean dmaHD_LoadSound(sfx_t *sfx) {
	...
	if (lpext != NULL) {
		strcat(dmahd_soundName, lpext);
	}
	// just check if file exists
	if (FS_FOpenFileRead(dmahd_soundName, NULL, qtrue) == qtrue) {
		// load it in.
		if (!(data = S_CodecLoad(dmahd_soundName, &info))) {
			return qfalse;
		}
	} else {
		// load it in.
		if (!(data = S_CodecLoad(sfx->soundName, &info))) {
			return qfalse;
		}
	}
	// information
	...
	Hunk_FreeTempMemory(data); // Tobias: CHECK
...
/*
=======================================================================================================================================
dmaHD_PaintChannelFrom16_HHRTF
=======================================================================================================================================
*/
...
/*
=======================================================================================================================================
dmaHD_PaintChannelFrom16_dmaEX2
=======================================================================================================================================
*/
...
/*
=======================================================================================================================================
dmaHD_PaintChannelFrom16_dmaEX
=======================================================================================================================================
*/
...
void dmaHD_SpatializeOrigin_HHRTF(vec3_t so, channel_t *ch) {
	...
	if (distl != 0 || distr != 0) {
		...
		if (dmaHD_Mixer->integer == 10) {
			// sound originating from above viewer (decrease bass), sound originating from below viewer (increase bass)
...
void dmaHD_Update_Mix(void) {
	...
	if ((sane = thisTime - lastTime) < 8) {
		sane = 8; // ms since last mix (cap to 8ms @ 125fps)
	}
...
void dmaHD_SoundList(void) {
	...
	if (s_numSfx > 0 || g_dmaHD_allocatedsoundmemory > 0) {
		for (sfx = s_knownSfx, i = 0; i < s_numSfx; i++, sfx++) {
			Com_Printf(" %s %.2f KiB %s\n", sfx->soundName, (float)sfx->soundLength / 1024.0f, (sfx->inMemory ? "" : "!"));
		}
