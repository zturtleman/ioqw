...
void CL_Init(void) {
	...
	// init cg_autoswitch and cg_cyclePastGauntlet so the ui will have it correctly even if the cgame hasn't been started
	Cvar_Get("cg_autoswitch", "1", CVAR_ARCHIVE);
	Cvar_Get("cg_cyclePastGauntlet", "1", CVAR_ARCHIVE);
