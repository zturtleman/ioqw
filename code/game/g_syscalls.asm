...
equ trap_EA_Move							-405
equ trap_EA_MoveUp							-406
equ trap_EA_MoveDown						-407
equ trap_EA_MoveForward						-408
equ trap_EA_MoveBack						-409
equ trap_EA_MoveLeft						-410
equ trap_EA_MoveRight						-411
equ trap_EA_Attack							-412
equ trap_EA_Action							-413
equ trap_EA_Use								-414
equ trap_EA_View							-415
equ trap_EA_Crouch							-416
equ trap_EA_SelectWeapon					-417
equ trap_EA_Say								-418
equ trap_EA_SayTeam							-419
equ trap_EA_Command							-420
equ trap_EA_Gesture							-421
