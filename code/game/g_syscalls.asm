...
equ trap_EntityContactCapsule				-121
equ trap_GetEntityToken						-122
equ trap_DebugPolygonCreate					-123
equ trap_DebugPolygonDelete					-124
equ trap_BotAllocateClient					-125
equ trap_BotFreeClient						-126
