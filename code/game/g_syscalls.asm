...
equ	trap_Cvar_VariableIntegerValue	-9
equ	trap_Cvar_VariableStringBuffer	-10
equ	trap_Argc				-11
equ	trap_Argv				-12
...
equ	trap_Cmd_ExecuteText	-19
equ	trap_LocateGameData		-20
equ	trap_DropClient			-21
equ	trap_SendServerCommand	-22
equ	trap_SetConfigstring	-23
equ	trap_GetConfigstring	-24
equ	trap_GetUserinfo		-25
equ	trap_SetUserinfo		-26
equ	trap_GetServerinfo		-27
equ	trap_SetBrushModel		-28
equ	trap_Trace				-29
equ	trap_PointContents		-30
equ trap_InPVS				-31
equ	trap_InPVSIgnorePortals	-32
equ	trap_AdjustAreaPortalState	-33
equ	trap_AreasConnected		-34
equ	trap_LinkEntity			-35
equ	trap_UnlinkEntity		-36
equ	trap_EntitiesInBox		-37
equ	trap_EntityContact		-38
equ	trap_BotAllocateClient	-39
equ	trap_BotFreeClient		-40
equ	trap_GetUsercmd			-41
equ	trap_GetEntityToken		-42
equ	trap_FS_GetFileList		-43
equ trap_DebugPolygonCreate	-44
equ trap_DebugPolygonDelete	-45
equ trap_RealTime			-46
equ trap_SnapVector			-47
equ trap_TraceCapsule		-48
equ trap_ClipToEntities		-49
equ trap_EntityContactCapsule	-50
equ trap_FS_Seek -51
