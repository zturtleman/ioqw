...
void Weapon_ShotgunFire (gentity_t *ent) {
	gentity_t		*tent;
...
void Weapon_NailgunFire (gentity_t *ent) {
	gentity_t	*m;
	int			count;
...
void Weapon_ProxlauncherFire (gentity_t *ent) {
	gentity_t	*m;
...
void Weapon_GrenadelauncherFire (gentity_t *ent) {
	gentity_t	*m;
...
void Weapon_RocketLauncherFire (gentity_t *ent) {
	gentity_t	*m;
...
void Weapon_BeamgunFire( gentity_t *ent ) {
	trace_t		tr;
	vec3_t		end;
...
void Weapon_RailgunFire (gentity_t *ent) {
	vec3_t		end;
	trace_t		trace;
	gentity_t	*tent;
	gentity_t	*traceEnt;
...
void Weapon_PlasmagunFire (gentity_t *ent) {
	gentity_t	*m;
...
void Weapon_BFGFire ( gentity_t *ent ) {
	gentity_t	*m;
...
void FireWeapon( gentity_t *ent ) {
	...
	case WP_CHAINGUN:
		...
		break;
	case WP_SHOTGUN:
		Weapon_ShotgunFire( ent );
		break;
	case WP_NAILGUN:
		Weapon_NailgunFire( ent );
		break;
	case WP_PROXLAUNCHER:
		Weapon_ProxlauncherFire( ent );
		break;
	case WP_GRENADELAUNCHER:
		Weapon_GrenadelauncherFire( ent );
		break;
	case WP_ROCKETLAUNCHER:
		Weapon_RocketLauncherFire( ent );
		break;
	case WP_BEAMGUN:
		Weapon_BeamgunFire( ent );
		break;
	case WP_RAILGUN:
		Weapon_RailgunFire( ent );
		break;
	case WP_PLASMAGUN:
		Weapon_PlasmagunFire( ent );
		break;
	case WP_BFG:
		Weapon_BFGFire( ent );
		break;
