...
char *BotWeaponNameForMeansOfDeath(int mod) {
	switch(mod) {
		...
		case MOD_BEAMGUN: return "Beam Gun";
...
int BotValidChatPosition(bot_state_t *bs) {
	...
	if (bs->inventory[INVENTORY_QUAD] ||
		...
		bs->inventory[INVENTORY_REGEN]) return qfalse;
