...
void R_Register( void ) 
{
	...
	r_forceSun = ri.Cvar_Get( "r_forceSun", "1", CVAR_ARCHIVE | CVAR_LATCH );
	...
	r_maxpolys = ri.Cvar_Get( "r_maxpolys", va("%d", MAX_POLYS*4), 0);
	r_maxpolyverts = ri.Cvar_Get( "r_maxpolyverts", va("%d", MAX_POLYVERTS*4), 0);
	r_maxpolybuffers = ri.Cvar_Get( "r_maxpolybuffers", va("%d", MAX_POLYBUFFERS*4), 0);
