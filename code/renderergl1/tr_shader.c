...
// Tobias FIXME:	{"metalsteps",	0,	SURF_METALSTEPS,0 },
// Tobias FIXME:	{"flesh",		0,	SURF_FLESH,		0 },
...
// Tobias FIXME:	,{"dust",		0,	SURF_DUST, 0}			// leave a dust trail when walking on this surface
};
