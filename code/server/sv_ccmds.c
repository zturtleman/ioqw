...
static void SV_Map_f(void) {
	...
	// if we go forward loading the map, the pure list will be cleared in SV_SpawnServer before further access to the bsp
...
static void SV_ConSayto_f(void) {
	...
	rawname = Cmd_Argv(1);
	// allowing special characters in the console with hex strings for player names
