...
#define MAT_FROZENGRASS_GR_COL_01	0x01700000 // short frozen grass with dried up leaves on the floor
#define MAT_FROZENGRASS_GR_COL_02	0x01800000
#define MAT_FROZENGRASS_GR_COL_03	0x01900000
#define MAT_FROZENGRASS_GR_COL_04	0x01A00000
#define MAT_LONGGRASS_GR_COL_01		0x01B00000 // long grass
#define MAT_LONGGRASS_GR_COL_02		0x01C00000
#define MAT_LONGGRASS_GR_COL_03		0x01D00000
#define MAT_LONGGRASS_GR_COL_04		0x01E00000
...
#define MAT_DIRT_GR_COL_01			0x03300000 // hard mud
#define MAT_DIRT_GR_COL_02			0x03400000
#define MAT_DIRT_GR_COL_03			0x03500000
#define MAT_DIRT_GR_COL_04			0x03600000
...
#define MAT_GRATE_01				0x09000000
#define MAT_GRATE_02				0x09100000
#define MAT_GRATE_ROBUST_01			0x09200000 // solid girders
#define MAT_GRATE_ROBUST_02			0x09300000
#define MAT_FENCE					0x09400000
#define MAT_BARREL					0x09500000
#define MAT_POT						0x09600000
#define MAT_WOOD_SOLID_DARK			0x09700000
#define MAT_WOOD_SOLID_DARK_FROZEN	0x09800000
#define MAT_WOOD_SOLID_DARK_SNOW	0x09900000
#define MAT_WOOD_SOLID_DARK_SLUSH	0x09A00000
#define MAT_WOOD_SOLID_DARK_SPLASH	0x09B00000 // light covering of water on a wooden surface
#define MAT_WOOD_SOLID_BRIGHT		0x09C00000 // freshly cut timber
#define MAT_WOOD_HOLLOW_DARK		0x09D00000
#define MAT_WOOD_HOLLOW_BRIGHT		0x09E00000
#define MAT_WOOD_CREAKING_DARK		0x09F00000 // termite infested dark creaky wood
#define MAT_WOOD_CREAKING_BRIGHT	0x0A000000 // termite infested fresh creaky wood
#define MAT_ROOF					0x0A100000
#define MAT_ROOF_FROZEN				0x0A200000
#define MAT_ROOF_SNOW				0x0A300000
#define MAT_ROOF_SLUSH				0x0A400000
#define MAT_ROOF_SPLASH				0x0A500000
...
#define MAT_GLASS					0x0AE00000
#define MAT_GLASS_SHARDS			0x0AF00000
#define MAT_TRASH_GLASS				0x0B000000
#define MAT_TRASH_DEBRIS			0x0B100000
#define MAT_TRASH_WIRE				0x0B200000
#define MAT_TRASH_PACKING			0x0B300000
#define MAT_TRASH_PLASTIC			0x0B400000
#define MAT_PLASTIC_HARD			0x0B500000
#define MAT_PLASTIC_SOFT			0x0B600000
#define MAT_CANVAS					0x0B700000 // tent material
#define MAT_RUBBER					0x0B800000 // hard tire like rubber
#define MAT_COMPUTER				0x0B900000 // computers/electronic equipment
#define MAT_FLESH					0x0BA00000 // hung meat, corpses in the world
