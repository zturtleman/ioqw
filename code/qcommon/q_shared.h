...
#define BUTTON_WALKING		0x00000002 // walking can't just be inferred from MOVE_RUN because a key pressed late in the frame will only generate a small move value for that frame walking will use different animations and won't generate footsteps
#define BUTTON_USE_HOLDABLE	0x00000004
#define BUTTON_GESTURE		0x00000008
#define BUTTON_AFFIRMATIVE	0x00000010
#define BUTTON_NEGATIVE		0x00000020
#define BUTTON_GETFLAG		0x00000040
#define BUTTON_GUARDBASE	0x00000080
#define BUTTON_FOLLOWME		0x00000100
#define BUTTON_PATROL		0x00000200
#define BUTTON_TALK			0x00000400 // displays talk balloon and disables actions
#define BUTTON_ANY			0x00000800 // any key whatsoever
