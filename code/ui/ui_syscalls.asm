...
equ trap_PC_RemoveAllGlobalDefines			-57
equ	trap_PC_LoadSource						-58
equ trap_PC_FreeSource						-59
equ trap_PC_ReadToken						-60
equ trap_PC_UnreadToken						-61
...
equ trap_LAN_ServerStatus					-82
equ trap_LAN_GetServerPing					-83
equ trap_LAN_ServerIsVisible				-84
equ trap_LAN_CompareServers					-85
equ trap_FS_Seek							-86
