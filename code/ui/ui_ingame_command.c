...
static itemList_t dm_itemList[] = {
	...
	{"Heavy Machinegun", "HMG", "weapon_heavy_machinegun", qfalse, "icons/iconw_hmgun", 0},
	{"Chaingun", "CG", "weapon_chaingun", qfalse, "icons/iconw_chaingun", 0},
	{"Shotgun", "SG", "weapon_shotgun", qfalse, "icons/iconw_shotgun", 0},
	{"Nailgun", "NG", "weapon_nailgun", qfalse, "icons/iconw_nailgun", 0},
	{"Phosphorgun", "PPG", "weapon_phosphorgun", qfalse, "icons/iconw_phosphorgun", 0},
	{"Proximity mine launcher", "Proxlauncher", "weapon_prox_launcher", qfalse, "icons/iconw_proxlauncher", 0},
