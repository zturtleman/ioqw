...
// Tobias FIXME: 1: Changing the gametype from >= GT_TEAM -> GT_FFA -> >= GT_TEAM will switch teams for connected players, and also displays the wrong HUD (Free for all HUD in team gametypes and vice versa, etc.)!
