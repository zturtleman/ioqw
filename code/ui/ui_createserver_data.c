...
itemnode_t server_itemlist[ITEM_COUNT] = {
	...
	{ITEMGROUP_WEAPON, ITEM_PROXLAUNCHER, "weapon_proxylauncher", "Proxlauncher"},
	...
	{ITEMGROUP_WEAPON, ITEM_BEAMGUN, "weapon_beamgun", "BG"},
	...
	{ITEMGROUP_AMMO, ITEM_BEAMGUN_AMMO, "ammo_cartridge", "BGA"},
	...
	{ITEMGROUP_ARMOR, ITEM_ARMORCOMBAT, "item_armor_combat", "GA"},
	{ITEMGROUP_ARMOR, ITEM_ARMORBODY, "item_armor_body", "YA"},
	{ITEMGROUP_ARMOR, ITEM_ARMORFULL, "item_armor_full", "RA"},
	// holdable items
	{ITEMGROUP_HOLDABLE, ITEM_MEDKIT, "holdable_medkit", "Syringe"},
