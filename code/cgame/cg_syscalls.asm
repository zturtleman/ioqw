...
equ trap_R_AddPolyBufferToScene				-310
equ trap_R_RenderScene						-311
equ trap_R_SetColor							-312
equ trap_R_DrawStretchPic					-313
equ trap_R_DrawStretchPicGradient			-314
equ trap_R_DrawRotatedPic					-315
equ trap_R_LerpTag							-316
equ trap_R_ModelBounds						-317
equ trap_R_RemapShader						-318
equ trap_R_SetClipRegion					-319
