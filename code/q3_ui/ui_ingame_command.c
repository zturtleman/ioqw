...
// the gauntlet, handgun and machine gun are excluded from the list because they are the default weapons, maps usually don't have them as available for pickup.
static itemList_t dm_itemList[] = {
	{"Mega Health", "MH", "item_health_mega", qfalse, "icons/iconh_mega", 0},
	{"Armor", "GA", "item_armor_combat", qfalse, "icons/iconr_green", 0},
	{"Heavy Armor", "YA", "item_armor_body", qfalse, "icons/iconr_yellow", 0},
	{"Full Armor", "RA", "item_armor_full", qfalse, "icons/iconr_red", 0},
	{"Heavy Machine Gun", "HMG", "weapon_heavy_machinegun", qfalse, "icons/iconw_hmgun", 0},
	{"Chain Gun", "CG", "weapon_chaingun", qfalse, "icons/iconw_chaingun", 0},
	{"Shotgun", "SG", "weapon_shotgun", qfalse, "icons/iconw_shotgun", 0},
	{"Nail Gun", "NG", "weapon_nailgun", qfalse, "icons/iconw_nailgun", 0},
	{"Phosphor Gun", "PPG", "weapon_phosphorgun", qfalse, "icons/iconw_phosphorgun", 0},
	{"Proximity Launcher", "Proxlauncher", "weapon_proxylauncher", qfalse, "icons/iconw_proxlauncher", 0},
	{"Grenade Launcher", "GL", "weapon_grenadelauncher", qfalse, "icons/iconw_grenade", 0},
	{"Napalm Launcher", "NL", "weapon_napalmlauncher", qfalse, "icons/iconw_napalm", 0},
	{"Rocket Launcher", "RL", "weapon_rocketlauncher", qfalse, "icons/iconw_rocket", 0},
	{"Beam Gun", "BG", "weapon_beamgun", qfalse, "icons/iconw_lightning", 0},
	{"Railgun", "RG", "weapon_railgun", qfalse, "icons/iconw_railgun", 0},
	{"Plasma Gun", "PG", "weapon_plasmagun", qfalse, "icons/iconw_plasma", 0},
	{"BFG 10K", "BFG", "weapon_bfg", qfalse, "icons/iconw_bfg", 0},
	{"Missile Launcher", "ML", "weapon_missilelauncher", qfalse, "icons/iconw_missile", 0},
	{"Medkit", "Syringe", "holdable_medkit", qfalse, "icons/medkit", 0},
	{"Kamikaze", "Kamikazi", "holdable_kamikaze", qfalse, "icons/kamikaze", 0},
	{"Quad Damage", "Quad", "item_quad", qfalse, "icons/quad", 0},
	{"Invisibility", "Invis", "item_invis", qfalse, "icons/invis", 0},
	{"Regeneration", "Regen", "item_regen", qfalse, "icons/regen", 0},
	{"Ammo Regen", "Ammoregen", "item_ammoregen", qfalse, "icons/ammo_regen", 0},
	{"Guard", "Guard", "item_guard", qfalse, "icons/guard", 0},
	{"Doubler", "Doubler", "item_doubler", qfalse, "icons/doubler", 0},
	{"Scout", "Scout", "item_scout", qfalse, "icons/scout", 0}
};
