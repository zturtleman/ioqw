...
#define CHARACTERISTIC_ATTACK_DISTANCE				19 // integer [1, 1000]
// attack range (added/substracted to/from attack distance)
#define CHARACTERISTIC_ATTACK_RANGE					20 // integer [1, 1000]
// attack skill
// >  0.0 && < 0.2 = don't move
...
#define CHARACTERISTIC_ATTACK_SKILL					21 // float [0, 1]
// tendency to crouch
#define CHARACTERISTIC_CROUCHER						22 // float [0, 1]
// tendency to jump
#define CHARACTERISTIC_JUMPER						23 // float [0, 1]
// tendency to walk
#define CHARACTERISTIC_WALKER						24 // float [0, 1]
// tendency to jump using a weapon
#define CHARACTERISTIC_WEAPONJUMPING				25 // float [0, 1]
//=====================================================================================================================================
// WEAPON
//=====================================================================================================================================
// skill when aiming
...
#define CHARACTERISTIC_AIM_SKILL					26 // float [0, 1]
// weapon specific aim skill
#define CHARACTERISTIC_AIM_SKILL_NAILGUN			27 // float [0, 1]
#define CHARACTERISTIC_AIM_SKILL_PROXLAUNCHER		28 // float [0, 1]
#define CHARACTERISTIC_AIM_SKILL_GRENADELAUNCHER	29 // float [0, 1]
#define CHARACTERISTIC_AIM_SKILL_ROCKETLAUNCHER		30 // float [0, 1]
#define CHARACTERISTIC_AIM_SKILL_PLASMAGUN			31 // float [0, 1]
#define CHARACTERISTIC_AIM_SKILL_BFG10K				32 // float [0, 1]
// accuracy when aiming
#define CHARACTERISTIC_AIM_ACCURACY					33 // float [0, 1]
// weapon specific aim accuracy
#define CHARACTERISTIC_AIM_ACCURACY_MACHINEGUN		34 // float [0, 1]
#define CHARACTERISTIC_AIM_ACCURACY_CHAINGUN		35 // float [0, 1]
#define CHARACTERISTIC_AIM_ACCURACY_SHOTGUN			36 // float [0, 1]
#define CHARACTERISTIC_AIM_ACCURACY_NAILGUN			37 // float [0, 1]
#define CHARACTERISTIC_AIM_ACCURACY_PROXLAUNCHER	38 // float [0, 1]
#define CHARACTERISTIC_AIM_ACCURACY_GRENADELAUNCHER	39 // float [0, 1]
#define CHARACTERISTIC_AIM_ACCURACY_ROCKETLAUNCHER	40 // float [0, 1]
#define CHARACTERISTIC_AIM_ACCURACY_BEAMGUN			41 // float [0, 1]
#define CHARACTERISTIC_AIM_ACCURACY_RAILGUN			42 // float [0, 1]
#define CHARACTERISTIC_AIM_ACCURACY_PLASMAGUN		43 // float [0, 1]
#define CHARACTERISTIC_AIM_ACCURACY_BFG10K			44 // float [0, 1]
// how much the bot fires its weapon (continuous or bursts)
#define CHARACTERISTIC_FIRETHROTTLE					45 // float [0, 1]
#define CHARACTERISTIC_LEADER_STRATEGY				46 // integer [1, 4]
//=====================================================================================================================================
// CHAT
//=====================================================================================================================================
// tendency to insult/praise
#define CHARACTERISTIC_CHAT_INSULT					47 // float [0, 1]
// tendency to chat about miscellaneous subject
#define CHARACTERISTIC_CHAT_MISC					48 // float [0, 1]
// tendency to chat at start or end of level
#define CHARACTERISTIC_CHAT_STARTENDLEVEL			49 // float [0, 1]
// tendency to chat entering or exiting the game
#define CHARACTERISTIC_CHAT_ENTEREXITGAME			50 // float [0, 1]
// tendency to chat when the character killed someone
#define CHARACTERISTIC_CHAT_KILL					51 // float [0, 1]
// tendency to chat when the character died
#define CHARACTERISTIC_CHAT_DEATH					52 // float [0, 1]
// tendency to chat when enemy commits suicide
#define CHARACTERISTIC_CHAT_ENEMYSUICIDE			53 // float [0, 1]
// tendency to chat when hit while chatting
#define CHARACTERISTIC_CHAT_HITTALKING				54 // float [0, 1]
// tendency to chat when bot was hit but didn't die
#define CHARACTERISTIC_CHAT_HITNODEATH				55 // float [0, 1]
// tendency to chat when bot hit the enemy but enemy didn't die
#define CHARACTERISTIC_CHAT_HITNOKILL				56 // float [0, 1]
// tendency to chat at random moments
#define CHARACTERISTIC_CHAT_RANDOM					57 // float [0, 1]
// tendency to reply to chats
#define CHARACTERISTIC_CHAT_REPLY					58 // float [0, 1]
