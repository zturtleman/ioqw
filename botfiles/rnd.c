...
D_PRAISE3 = {
	"Not gonna let you do that again, ",0,".";
	"Smooo-oooth";
...
response_insult = {
	...
	"~You got personal problems, take them to your ",random_counselor,".";
...
"Keep Fritzkrieg away from the ~railgun.";
...
"NEVER, never, never let Fritzkrieg or Xaero get the ~railgun!";
