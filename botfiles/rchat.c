...
["blow me", "blowjob", "blow job", "bj", "fellatio", "suck my"] = 6
{
	...
	"That's illegal in ",place,", you know.";
...
["louisiana", "cajun", "creole", "zydeco", "New Orleans"] = 4
{
	...
	"~You all want fries with that gator?";
...
["love", !"you", !name] = 6
{
	...
	"'~They' say that ",femalebot," and ",femalebot," are a couple.";
}
...
[""] = 0
{
	...
	ramble;
	"Like I should care.";
	"Maybe I should talk to the arena masters.";
	"Huh?";
