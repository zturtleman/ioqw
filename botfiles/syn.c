...
CONTEXT_NEARBYITEM
{
	...
	[("Handgun", 1), ("HG", 0)]
	[("Machinegun", 1), ("MG", 0)]
	[("Heavy Machinegun", 1), ("HMG", 0)]
	[("Chaingun", 1), ("CG", 0)]
	[("Shotgun", 1), ("SG", 0.5)]
	[("Nailgun", 1), ("NG", 0)]
	[("Phosphorgun", 1), ("PPG", 0.5)]
	[("Proxlauncher", 1), ("Proximitylauncher", 0.5)]
	[("Grenadelauncher", 1), ("GL", 0.7)]
	[("Napalmlauncher", 1), ("NL", 0.7)]
	[("Rocketlauncher", 1), ("RL", 0.7)]
	[("Lightninggun", 1), ("LG", 0.7)]
	[("Railgun", 1), ("Rail", 0.5), ("RG", 0)]
	[("Plasmagun", 1), ("Plasma", 0.7), ("PG", 0)]
	[("BFG10K", 1), ("BFG", 1)]
	[("Missilelauncher", 1), ("ML", 1)]
	// powerups
	[("Kamikaze", 1), ("Kamikazi", 0)]
	[("Quad Damage", 1), ("Quad", 0.7)]
	[("Invisibility", 1), ("Invis", 0)]
	[("Regeneration", 1), ("Regen", 0.6)]
	[("Ammoregen", 1), ("Ammoregen Powerup", 0.5)]
	[("Guard", 1), ("Guard Powerup", 0.5)]
	[("Doubler", 1), ("Doubler Powerup", 0.5)]
	[("Scout", 1), ("Scout Powerup", 0.5)]
